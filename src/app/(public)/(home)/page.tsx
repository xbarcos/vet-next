          ...
          <div className="w-full px-4 md:px-6 relative">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
                Digitalize sua moeda local
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Sua Moeda é a plataforma certa para te auxiliar em todo o processo
                de digitalizar sua moeda. Melhore o mercado da cidade ao adicionar
                lojas no nosso app.
              </p>
              ...
              <div className="flex items-center justify-center gap-4 mt-6 text-sm text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  <span>Pagamentos on-line</span>
                </div>
                <div className="flex items-center gap-1">
                  <Check className="size-4 text-primary" />
                  <span>Faça transferências na sua moeda local</span>
                </div>
                <div className="flex items-center gap-1">
                  <Check className="size-4 text-primary" />
                  <span>Faça o dinheiro rodar na sua cidade</span>
                </div>
              </div>
            </motion.div>
